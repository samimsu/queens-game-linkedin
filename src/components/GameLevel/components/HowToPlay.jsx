      ...
      <ol className="list-decimal space-y-2">
        <li className="ml-4">
          <Trans i18nKey="GAME_GOAL_INSTRUCTION">
            <b className="font-medium"></b> <Queen size="20" className="inline mx-1 mb-1" /><b className="font-medium"></b>
          </Trans>
        </li>
        <li className="ml-4">
        <Trans i18nKey="TAPS_INSTRUCTION">
          - <Queen size="20" className="inline mx-1 mb-1" /><Queen size="20" className="inline mx-1 mb-1" />
        </Trans>
        </li>
        <li className="ml-4">
